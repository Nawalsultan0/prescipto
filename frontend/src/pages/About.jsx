     ...
     <div className=' text-xl my-4'>
      <p className=' underline' >WHY <span className=' text-gray-700 font-semibold'> CHOOSE US</span> </p>
       ...
       <div className=' flex  flex-col  md:flex-row mb-20 '>
        <div className=' border border-gray-300 px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px] hover:bg-primary  hover:text-white transition-all duration-300 text-gray-600 cursor-pointer  '>
          <b>EFFICIENCY:</b>
