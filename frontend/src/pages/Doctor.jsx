    ...
    <div>
      ...
      <div className='flex flex-col sm:flex-row items-start gap-5 mt-5 '>
        ...
        <div className='flex flex-col gap-4 text-sm text-gray-600  '>
          ...
          className={`w-[94vw] sm:w-auto pl-3 py-1.5 pr-16 
            border border-gray-300 rounded transition-all cursor-pointer ${speciality === "" ? "bg-indigo-100 text-black" : ""} `}>
             Gastroenterologist
              </p>
        </div>
        ...
        <div className='w-full grid grid-cols-[repeat(auto-fill,minmax(200px,1fr))] gap-4 gap-y-6'>
          ...
          FilterDoc.map((item,index)=>(
                ...
                <div onClick={()=>navigate(`/appointment/${item._id}`)} className='border border-blue-200 rounded-xl  overflow-hidden cursor-pointer hover:translate-y-[-10%] duration-500'key={index}>
